...
<template>
  <header>
    <div>
      <a href="/Jasen_Tenney_2026.pdf" target="_blank" class="name-link" title="View my resume (PDF)" aria-label="View my resume (PDF)">Jasen Tenney</a>
    </div>
    <div>
      <a href="/Jasen_Tenney_2026.pdf" target="_blank" title="View my resume (PDF)" aria-label="View my resume (PDF)">
        <img src="/resume.svg" alt="" width="30" height="30" />
      </a>
    </div>
    <div>
